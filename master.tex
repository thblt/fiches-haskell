...
\setmonofont[Scale=MatchLowercase]{InconsolataForPowerline-g}
...
% adding adds undesirable extra spaces in code.
...
{}%Label
{0em}%Sep
{\rule{1ex}{1ex}\hspace{.5em}\sffamily\textbf}%before-code
%[]%after-code
...
\newenvironment{halfwidth}{%
    \begin{minipage}[t][][l]{\textwidth/2-.5em}%
}{%
    \end{minipage}%
}

\newcommand\sidebyside[2]{\noindent\begin{halfwidth}#1\end{halfwidth}\hfill\begin{halfwidth}#2\end{halfwidth}}
