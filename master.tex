\documentclass[final,a4paper,landscape,french]{article}
...
\usepackage[margin=1cm, rmargin=15.85cm]{geometry}
...
\setlist[ilenum]{label=\alph*,afterlabel=)\ }
...
\newenvironment{lawbox}[1][]{\begin{framed}\begin{iconbox}{\boxiconwidth}{./images/law.pdf}{#1}}{\end{iconbox}\end{framed}}
\newenvironment{mathbox}[1][]{\begin{framed}\begin{iconbox}{\boxiconwidth}{./images/math.pdf}{#1}}{\end{iconbox}\end{framed}}
...
\newenvironment{lawblock}{\begin{iconblock}{\totalheightof{X}}{./images/law.pdf}}{\end{iconblock}}
\newenvironment{mathblock}{\begin{iconblock}{\totalheightof{X}}{./images/math.pdf}}{\end{iconblock}}
